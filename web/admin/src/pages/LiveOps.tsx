...
// Deve espelhar LiveOps.DEFAULT_CONFIG.economy.milestones do jogo (V3).
const DEFAULT_MILESTONES = [
  [25, 1.5], [50, 3], [75, 1.5], [100, 7],
  [150, 1.5], [200, 3], [250, 1.5], [300, 7],
  [400, 1.5], [500, 7], [600, 1.5], [700, 3], [800, 1.5], [900, 3], [1000, 7],
] as const;

const DEFAULT_BALANCE: LiveOpsBalanceConfig = {
  economy: {
    growthSegments: [
      { maxQuantity: 300, rate: 1.11 }, { maxQuantity: 1000, rate: 1.05 },
    ...
    generalMilestones: [
      ...
      { quantity: 500, type: "prod", multiplier: 2, gems: 20, relics: 50 },
      { quantity: 800, type: "prod", multiplier: 2.5, gems: 30, relics: 75 },
      { quantity: 1000, type: "prod", multiplier: 4, gems: 100, relics: 150 },
    ],
  },
  boosts: {
              ...
              <div className="panel liveops-editor">
                ...
                >
                  <div className="liveops-field-grid">
                    <NumberField id="balance-saint" label="Bônus por Santo" hint="Percentual somado por Santo ganho" value={balanceDraft.economy.saintBonus * 100} min={0} max={1_000} step={0.5} suffix="%" onChange={(value) => setBalanceDraft({ ...balanceDraft, economy: { ...balanceDraft.economy, saintBonus: value / 100 } })} />
