/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example ./worker-configuration.d.ts` (hash: acba406ff2d6077f3c02c525f99059a3)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	DELETIONS_DB: D1Database;
	LIVEOPS_DB: D1Database;
	ACCOUNT_CREATE_LIMITER: RateLimit;
	ACCOUNT_CREATE_IP_LIMITER: RateLimit;
	ACCOUNT_RECOVERY_LIMITER: RateLimit;
	ACCOUNT_RECOVERY_IP_LIMITER: RateLimit;
	SAVE_READ_LIMITER: RateLimit;
	SAVE_WRITE_LIMITER: RateLimit;
	SECURITY_LIMITER: RateLimit;
	WALLET_LIMITER: RateLimit;
	ENVIRONMENT: "staging" | "production" | "development";
	ENABLE_DEV_ADMIN: "false" | "true";
	PUBLIC_WEB_ORIGIN: "https://mana-idle-landing-staging.spankk-bolter.workers.dev" | "https://manaidle.com" | "http://localhost:5173";
	ADMIN_WEB_ORIGIN: "https://mana-idle-admin-staging.spankk-bolter.workers.dev" | "https://admin.manaidle.com" | "http://localhost:5174";
	ACCESS_TEAM_DOMAIN: "https://still-field-f0c4.cloudflareaccess.com" | "https://replace-me.cloudflareaccess.com";
	ACCESS_AUD: "368085a329cfae1189f8e756d90f55822733dce0232dd2a4c9a6ebbaa496cc32" | "replace-after-production-access-app-is-created" | "replace-after-access-app-is-created";
	CURRENT_TOKEN_KEY_VERSION: "1";
	CURRENT_RECOVERY_KEY_VERSION: "1";
	SUPPORTED_SAVE_SCHEMA: "10";
	WALLET_MIGRATION_CAP: "500";
	DAILY_FREE_GEMS: "5";
	TOKEN_PEPPER_V1: string;
	RECOVERY_PEPPER_V1: string;
	DELETION_PEPPER_V1: string;
	TOKEN_PEPPER_V2: string;
	RECOVERY_PEPPER_V2: string;
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		PUBLIC_WEB_ORIGIN: "https://mana-idle-landing-staging.spankk-bolter.workers.dev";
		ADMIN_WEB_ORIGIN: "https://mana-idle-admin-staging.spankk-bolter.workers.dev";
		ACCESS_TEAM_DOMAIN: "https://still-field-f0c4.cloudflareaccess.com";
		ACCESS_AUD: "368085a329cfae1189f8e756d90f55822733dce0232dd2a4c9a6ebbaa496cc32";
		CURRENT_TOKEN_KEY_VERSION: "1";
		CURRENT_RECOVERY_KEY_VERSION: "1";
		SUPPORTED_SAVE_SCHEMA: "10";
		WALLET_MIGRATION_CAP: "500";
	...
	interface ProductionEnv {
		...
		ENABLE_DEV_ADMIN: "false";
		PUBLIC_WEB_ORIGIN: "https://manaidle.com";
		ADMIN_WEB_ORIGIN: "https://admin.manaidle.com";
		ACCESS_TEAM_DOMAIN: "https://replace-me.cloudflareaccess.com";
		ACCESS_AUD: "replace-after-production-access-app-is-created";
		CURRENT_TOKEN_KEY_VERSION: "1";
		CURRENT_RECOVERY_KEY_VERSION: "1";
		SUPPORTED_SAVE_SCHEMA: "10";
		WALLET_MIGRATION_CAP: "500";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ENABLE_DEV_ADMIN" | "PUBLIC_WEB_ORIGIN" | "ADMIN_WEB_ORIGIN" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "CURRENT_TOKEN_KEY_VERSION" | "CURRENT_RECOVERY_KEY_VERSION" | "SUPPORTED_SAVE_SCHEMA" | "WALLET_MIGRATION_CAP" | "DAILY_FREE_GEMS" | "TOKEN_PEPPER_V1" | "RECOVERY_PEPPER_V1" | "DELETION_PEPPER_V1" | "TOKEN_PEPPER_V2" | "RECOVERY_PEPPER_V2" | "DEV_ADMIN_TOKEN">> {}
}
