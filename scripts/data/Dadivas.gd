...
const DADOS: Array = [
	...
	{"id": "d_comprador_marcos", "nome": "Mordomia das Bencaos", "custo": 150, "tipo": "blessing_buyer", "mult": 1.0, "efeito": "Libera o Comprador de Bencaos na aba Milagres", "flavor": "Quem planeja a colheita reconhece cada tempo e cada medida."},
